...
var ASM_CONSTS = {
  3781104: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3781159: function($0) {performance.now = function() { return $0; };},  
 3781207: function($0) {performance.now = function() { return $0; };},  
 3781255: function() {performance.now = Module['emscripten_get_now_backup'];},  
 3781310: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3781371: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3781435: function() {return Module.webglContextAttributes.powerPreference;}
};
  ...
  function __VKWebAppAccelerometerStart(refresh_rate)
      {
          AccelerometerStart(refresh_rate);
      }

  function __VKWebAppAccelerometerStop()
      {
          AccelerometerStop();
      }

  function __VKWebAppInit()
      {
          initBridge();
      }

  function __VKWebAppShowInviteBox()
      {
          inviteFriend();
      }

  function __VKWebAppShowLeaderBoardBox(value)
      {
          ShowLeaderBoardBox(Pointer_stringify(value));
      }

  function __VKWebAppShowNativeAds(adFormat, waterfall)
      {
          showAd(Pointer_stringify(adFormat), waterfall);
      }

  function __VKWebAppShowSubscriptionBox(action, item, subscription_id)
      {
          ShowSubscriptionBox(Pointer_stringify(action), Pointer_stringify(item), Pointer_stringify(subscription_id));
      }

  function __VKWebAppShowWallPostBox(text)
      {
          sendPost(Pointer_stringify(text));
      }

  function __VKWebAppStorageGet(key)
      {
          storageGet(Pointer_stringify(key));
      }

  function __VKWebAppStorageSet(key, value)
      {
  ...
  function _getInfoUser(gameObject, method)
      {
...
var asmLibraryArg = {
  ...
  "_Send": __Send,
  "_VKWebAppAccelerometerStart": __VKWebAppAccelerometerStart,
  "_VKWebAppAccelerometerStop": __VKWebAppAccelerometerStop,
  "_VKWebAppInit": __VKWebAppInit,
  "_VKWebAppShowInviteBox": __VKWebAppShowInviteBox,
  "_VKWebAppShowLeaderBoardBox": __VKWebAppShowLeaderBoardBox,
  "_VKWebAppShowNativeAds": __VKWebAppShowNativeAds,
  "_VKWebAppShowSubscriptionBox": __VKWebAppShowSubscriptionBox,
  "_VKWebAppShowWallPostBox": __VKWebAppShowWallPostBox,
  "_VKWebAppStorageGet": __VKWebAppStorageGet,
  "_VKWebAppStorageSet": __VKWebAppStorageSet,
